...
public class AlunoController : ControllerBase
{
    ...
    [HttpPost("Enroll/")]
    public async Task<ActionResult<ServiceResponse<GetAlunoDTO>>> LinkAlunoToMateria(
        LinkMateriaAlunoDTO newLinkMateriaAluno
    )
    {
        try
        {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<ServiceResponse<GetAlunoDTO>>> UpdateAluno(
        UpdateAlunoDTO aluno,
        int id
    )
    {
        try
