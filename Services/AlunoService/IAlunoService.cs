namespace PortalNotas.Services.AlunoService
{
    public interface IAlunoService
    {
        ...
        Task<ServiceResponse<GetAlunoDTO>> AddAluno(AddAlunoDTO newAluno);
        Task LinkAlunoToMateria(LinkMateriaAlunoDTO newLinkMateriaAluno);
        Task UnlinkAlunoToMateria(LinkMateriaAlunoDTO unlinkMateriaAluno);
